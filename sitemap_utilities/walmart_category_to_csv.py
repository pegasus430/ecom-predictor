...
output_dir_path = "/home/mufasa/Documents/Workspace/Content Analytics/Misc/Walmart CSV by Categories/results 9 - 4/"

f = open('/home/mufasa/Documents/Workspace/Content Analytics/Misc/Walmart CSV by Categories/results 9 - 10/category urls.csv')
csv_f = csv.reader(f)
...
for category_url in category_url_list:
    ...
    url_list = category_html.xpath("//ul[contains(@class,'tile-list-grid')]/li//a[@class='js-product-title']/@href")
