...
def main():
    ...
    urls_image_pairs="""
    http://i5.walmartimages.com/dfw/dce07b8c-95e9/k2-_7851b98b-f3e6-48be-9981-f881f82fce7e.v1.jpg
    http://i5.walmartimages.com/dfw/dce07b8c-95e9/k2-_7851b98b-f3e6-48be-9981-f881f82fce7e.v1.jpg
    #######
    http://i5.walmartimages.com/dfw/dce07b8c-8262/k2-_4c10dca1-02c6-4bfd-9d50-099141d4f331.v1.jpg
    http://i5.walmartimages.com/dfw/dce07b8c-2225/k2-_81c1cbf0-fe1e-4e41-b6fe-1a2a4ec6be25.v1.jpg
    #######
    """
    ...
    for url_text in url_pairs:
        ...
        for url in pair:
            ...
            if not os.path.exists(filepath):
                logger.debug("downloading image %s to %s ..."%(url, download_base_directory))
