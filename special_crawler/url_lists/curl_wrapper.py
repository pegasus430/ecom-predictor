...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        url_end = re.findall(r'^(localhost:5000\/get_data\?url=)(.*)', url)[0][1]
        ...
        print "Please input correct argument.\nfor ex: python curl_wrapper.py 'localhost:5000/get_data?url=http://www.ozon.ru/context/detail/id/28659614/'"
        print '(Before, we used $ curl "localhost:5000/get_data?url=http://ww.ozon.ru/context/detail/id/28659614/")'
        print "######################################################################################################"
