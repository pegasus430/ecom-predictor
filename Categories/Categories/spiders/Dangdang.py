...
class BestsellerSpider(BaseSpider):
    ...
    start_urls = [
        "http://www.dangdang.com/Best-Sellers/zgbs/ref=zg_bs_unv_mas_0_mas_1",
    ]
    ...
    def parse(self, response):
        ...
        sitemap_url = "http://www.dangdang.com/gp/site-directory/ref=sa_menu_top_fullstore"
    ...
    def getDepartmentsBs(self, response):
        ...
        departments = []
        root_url = "http://www.dangdang.com"
    ...
    def getDepartmentBs(self, response):
        ...
        template_url = "http://www.dangdang.com/Best-Sellers-Books-Audiobooks/zgbs/books/368395011"
    ...
    def parseProduct(self, response):
        ...
        # format 2
        m2 = re.match("Dangdang\.com ?: (.*)", page_title, re.UNICODE)
        if m2:
