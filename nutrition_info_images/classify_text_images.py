...
def extract_features(filename, is_url=False):
    ...
    # smaller dimension will be 800, longer dimension will be proportional
...
def classifier_main():
    ...
    trained, clf = train(training_set, serialize_file="serialized_classifier/jet_nutrition_image_classifier.pkl")
    ...
    imgs, examples, labels = test_set
    nr_predicted = 0
    predicted = predict(test_set, clf, from_serialized_file="serialized_classifier/jet_nutrition_image_classifier.pkl")
...
def predict_textimage_type(image_url):
    ...
    # try fuzzy
    match = process.extractOne('nutrition', text)
    if match and match[1] > 80:
        return 'nutrition_facts'

    # match = process.extractOne('drug', text)
    # if match and match[1] > 85:
    #     return 'drug_facts'
    #
    # match = process.extractOne('supplement', text)
    # if match and match[1] > 85:
    #     return 'supplement_facts'
